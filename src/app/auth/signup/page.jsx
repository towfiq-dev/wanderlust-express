  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md bg-white shadow-xl rounded-2xl p-8 border border-gray-100">
        ...
        {/* Google Button */}
                <button type='submit' onClick={handleGoogleSignIn} className="w-full cursor-pointer rounded-xl border border-gray-200 py-3 font-medium text-gray-700 flex items-center justify-center transition hover:bg-gray-50">
